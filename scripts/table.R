...
states_table <- mutate(
  states_table, 
  WHITE_DIFF_FROM_AVG = mean((WHITE_GR04_READING - AVG_READING_4_SCORE) +
                                (WHITE_GR08_READING - AVG_READING_8_SCORE)),
  BLACK_DIFF_FROM_AVG = mean((BLACK_GR04_READING - AVG_READING_4_SCORE) +
                                    (BLACK_GR08_READING - AVG_READING_8_SCORE)),
  LATINX_DIFF_FROM_AVG = mean((LATINX_GR04_READING - AVG_READING_4_SCORE) -
                                (LATINX_GR08_READING - AVG_READING_8_SCORE)),
  ASIAN_DIFF_FROM_AVG = mean((ASIAN_GR04_READING - AVG_READING_4_SCORE) + 
                               (ASIAN_GR08_READING - AVG_READING_8_SCORE)),
  AMERICAN_INDIAN_ALASKA_NATIVE_DIFF_FROM_AVG = mean(
  ...
  HAWAIIAN_NATIVE_PACIFIC_ISLANDER_DIFF_FROM_AVG = mean(
  ...
  TWO_OR_MORE_RACES_DIFF_FROM_AVG = mean((TWO_OR_MORE_RACES_GR04_READING - 
  ...
  select(STATE,
         ...
         WHITE_DIFF_FROM_AVG,
         BLACK_DIFF_FROM_AVG,
         LATINX_DIFF_FROM_AVG,
         ASIAN_DIFF_FROM_AVG,
         AMERICAN_INDIAN_ALASKA_NATIVE_DIFF_FROM_AVG,
         HAWAIIAN_NATIVE_PACIFIC_ISLANDER_DIFF_FROM_AVG,
         TWO_OR_MORE_RACES_DIFF_FROM_AVG
         ) 
